...
It is intended for use in RPG Maker2003. By purchasing this pack, you have full rights to use these graphics in any RPG Maker program (2003, XP, VX, VX Ace and any future RPG Maker products), as well as IG Maker.
...
1. Open RPG Maker 2003:
Open RPG Maker 2003 and the project you wish to add the Resource Pack to. Select Resource Manager. Choose the resource files and then import them.

2. Creating the tileset:
In the RPG MAKER 2003 database, select the Tilesets tab. There you can add the imported graphics into a tileset.
