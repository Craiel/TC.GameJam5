namespace Jrpg.Game.Logic
{
    ...
    public abstract class Actor : GameComponent, IActor
    {
        ...
        private readonly IStatDictionary<float> statsBase;

        private readonly IStatDictionary<float> statsCurrent;

        private readonly IStatDictionary<float> statsMax;
        ...
        public void SetBaseStats(IStatDictionary<float> stats)
        {
